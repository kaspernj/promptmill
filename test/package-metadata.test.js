...
test("package.json declares publish metadata", async () => {
  ...
  assert.equal(pkg.name, "promptmill")
  assert.equal(pkg.license, "MIT")
  assert.equal(pkg.type, "module")
  assert.equal(pkg.homepage, "https://github.com/kaspernj/promptmill#readme")
  assert.equal(pkg.bugs.url, "https://github.com/kaspernj/promptmill/issues")
  assert.equal(pkg.repository.type, "git")
  assert.match(pkg.repository.url, /github\.com\/kaspernj\/promptmill/)
  assert.equal(pkg.bin.promptmill, "./bin/promptmill")
